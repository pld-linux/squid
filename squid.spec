...
# Source0-md5:	3e64468e123be1246d17486dab6bee87
...
Patch107:	%{name}-nolibs.patch
Patch108:	http://piorun.ds.pg.gda.pl/~blues/patches/%{name}-more_FD-new.patch
Patch109:	%{name}-empty-referer.patch
Patch110:	%{name}-align.patch

...
klientСw FTP i gopher. Squid przechowuje najczЙ╤ciej pobierane dane w
pamiЙci RAM i zapamiЙtuje odwoЁania do DNS. Squid oferuje wsparcie dla
SSL, rozbudowan╠ kontrolЙ dostЙpu oraz peЁne rejestrowanie pobieranych
danych. DziЙki u©yciu protokoЁu ICP (Internet Cache Protocol), serwer
squid mo©na Ё╠czyФ w hierarchiЙ, zwiЙkszaj╠c ich efektywno╤Ф. Pakiet
squid obejmuje: gЁСwny program serwera squid, program dostarczaj╠cy
...
Cachemgr.cgi jest skryptem CGI, ktСry pozwala administratorowi
zapoznaФ siЙ z informacjami o pracy Squida poprzez WWW.
...
Pakiet ten pozwala na autentykacjЙ LDAP za pomoc╠ prostej autentykacji
(otwartym tekstem).
...
Program ten pozwala na autentykacjЙ u©ytkownikСw squida w dowolnym
╪rСdle posiadaj╠cym moduЁ PAM.
...
To jest moduЁ autentykacji proxy. Z smb_auth mo©esz autentyfikowaФ
u©ytkownikСw proxy na serwerach SMB, jak Windows NT czy Samba.
